  ...
  return (
    <div className="flex flex-col justify-between gap-4 h-screen max-h-screen bg-transparent">
      ...
      <div className="basis-4/6 grid grid-rows-6 w-full pl-4 justify-start">
        <Link href="/" onClick={() => {tab === "Randomness" ? {} : switchTab("Randomness")}}>
        <button className={`place-self-start p-2 pr-10 row-span-1 ${tab === "Randomness" ? "text-white drop-shadow-red" : "text-white/60 hover:text-white hover:drop-shadow-red"} `}>
            Randomness
        </button>
        </Link>
